      ...
      <article className="container mx-auto px-4 max-w-4xl">
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-8">
            ...
            >
              <Heart
                className={`h-4 w-4 mr-2 ${liked ? "fill-red-400" : ""}`}
              />
          ...
          <div className="mb-12">
            ...
            <div className="flex flex-wrap gap-2">
              {post.tags.map((tag) => (
                <span
                  key={tag}
                  className="px-3 py-1 text-sm rounded-full bg-white/5 border border-white/10 hover:bg-white/10 transition-colors cursor-pointer"
                >
                  {tag}
                </span>
              ))}
            ...
            <form onSubmit={handleCommentSubmit} className="space-y-4">
              ...
              <div>
                ...
                <textarea
                  ...
                  required
                  rows={4}
                  className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-lg focus:outline-none focus:border-blue-500/50 transition-colors resize-none"
